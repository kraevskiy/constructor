    ...
    <>
      <Switch>
        ...
        <PublicRoute
          ...
          exact
        />
        <PrivateRoute path={paths.orders.index} component={OrdersPage} exact />
        <PrivateRoute
          path={paths.orders.create}
          component={CreateOrderPage}
          exact
        />
        <PrivateRoute path={paths.layouts} component={LayoutsPage} exact />
        <PrivateRoute path={paths.layout} component={LayoutsPage} exact />
        <PrivateRoute
          path={paths.setting}
